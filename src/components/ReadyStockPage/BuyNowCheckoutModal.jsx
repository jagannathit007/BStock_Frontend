...
const BuyNowCheckoutModal = ({ isOpen, onClose, product, quantity, onSuccess }) => {
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      ...
      console.log("Buy Now Order data being sent:", orderData);
...
<div
    ...
    >      <div className="bg-white rounded-xl shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Buy Now - Checkout</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex justify-end gap-3 p-6 border-t border-gray-200">
          ...
          <button
            ...
            className="bg-[#0071E0] text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-600 transition-all duration-200 flex items-center"
            disabled={isLoading}
          >
            {isLoading ? (
              <>
